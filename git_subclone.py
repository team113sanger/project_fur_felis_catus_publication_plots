...
REPO_SERIES = [
    ("git@gitlab.internal.sanger.ac.uk:DERMATLAS/fur/fur_germline.git", "0.3.1", "germline-plot"),
    ("git@gitlab.internal.sanger.ac.uk:DERMATLAS/fur/fur2cosmic.git", "73e915e14cc7c6b6d4f3f29b59b5fd1532c59ba3", "homology-plot"),
]
...
def clone_repo(repo_url, ref, subdir_path, force=False):
    ...
    if subdir_path.exists():
        if force:
            ...
            LOGGER.info(f"Directory already exists: {subdir_path}. Skipping. Use --force to overwrite.")
            return True
